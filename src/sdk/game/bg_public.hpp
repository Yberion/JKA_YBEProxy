...
qboolean BG_LegalizedForcePowers(char *powerOut, std::size_t powerOutSize, int maxRank, qboolean freeSaber, int teamForce, int gametype, int fpDisabled);
