...
#include "sdk/qcommon/q_math.hpp"
#include "sdk/qcommon/q_color.hpp"
#include "sdk/qcommon/q_string.hpp"
#include "sdk/qcommon/disablewarnings.hpp"
...
#include "sdk/game/surfaceflags.hpp"			// shared with the q3map utility
...
void NET_AddrToString( char *out, std::size_t size, void *addr );
...
void *Q_LinearSearch( const void *key, const void *ptr, std::size_t count,
	std::size_t size, cmpFunc_t cmp );
